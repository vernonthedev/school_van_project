<div class="container">
    ...
    <form action="{{ route('trips.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="van_id" value="{{old("van_id")}}">
            @error("van_id")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="van_student_id" value="{{old("van_student_id")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="sourceRoute" value="{{old("sourceRoute")}}">
            @error("sourceRoute")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="destinationRoute" value="{{old("destinationRoute")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="dateOfTrip" value="{{old("dateOfTrip")}}">
            @error("dateOfTrip")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="tripStatus" value="{{old("tripStatus")}}">
            @error("tripStatus")
                <p>{{$message}}</p>
            @enderror
        </div>
